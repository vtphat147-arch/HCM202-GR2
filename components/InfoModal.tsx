...
const InfoModal: React.FC<InfoModalProps> = ({ region, language, onClose, onStartQuiz }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-4 bg-black/60 backdrop-blur-sm transition-opacity duration-300">
      <div className="bg-white w-full max-w-2xl rounded-xl md:rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up flex flex-col max-h-[85dvh] md:max-h-[90vh]">
          ...
          {loading ? (
            ...
            <div className="h-full">
              ...
              {activeTab === 'milestones' && details && (
                <div className="space-y-6 md:space-y-8 animate-fade-in px-1 md:px-2 py-2 md:py-4">
              ...
              {/* --- QUIZ LAUNCHER TAB --- */}
              {activeTab === 'quiz' && (
                <div className="flex flex-col items-center justify-center h-full animate-fade-in text-center py-4 md:py-8">
